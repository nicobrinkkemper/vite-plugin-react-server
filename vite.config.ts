  ...
  build: {
    ...
    lib: {
      entry: {
        ...
        "plugin/dev-server/handleRscStream": resolve(__dirname, "plugin/dev-server/handleRscStream.ts"),
        "plugin/dev-server/handleRscStream.server": resolve(__dirname, "plugin/dev-server/handleRscStream.server.ts"),
        "plugin/dev-server/handleRscStream.client": resolve(__dirname, "plugin/dev-server/handleRscStream.client.ts"),
        "plugin/dev-server/createRscStream": resolve(__dirname, "plugin/dev-server/createRscStream.ts"),
        "plugin/dev-server/createRscStream.server": resolve(__dirname, "plugin/dev-server/createRscStream.server.ts"),
        "plugin/dev-server/createRscStream.client": resolve(__dirname, "plugin/dev-server/createRscStream.client.ts"),
