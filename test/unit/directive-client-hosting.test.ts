...
// Note: the file-level "use client" detector (hasFileLevelClientDirective) is an
// internal react-server-loader helper and is unit-tested in that repo
// (test/unit/hasFileLevelClientDirective.test.ts). vprs consumes only the public
// directives surface, exercised below.
