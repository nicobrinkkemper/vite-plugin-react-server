  ...
  if (msg && msg.type === "INIT") {
    ...
    try {
      ...
      dataPort.onmessage = (event: any) => {
        ...
        // Ignore null - let onEnd handle stream termination
      };
      ...
      handleHtmlRender(
        {
          ...
          projectRoot: options.projectRoot ?? workerData.userOptions.projectRoot,
          moduleRootPath: options.moduleRootPath ?? workerData.userOptions.moduleRootPath,
          moduleBasePath: options.moduleBasePath ?? workerData.userOptions.moduleBasePath,
          moduleBaseURL: options.moduleBaseURL ?? workerData.userOptions.moduleBaseURL,
