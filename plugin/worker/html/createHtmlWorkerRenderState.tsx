...
//     htmlTransform.on("data", (chunk: Uint8Array) => {
...
//       if (verbose) {
//         if (!chunk.length) {
//           logger.info(`[html-worker:${id}] HTML_CHUNK (backpressure)`);
//         } else {
//           logger.info(
//             `[html-worker:${id}] HTML_CHUNK ${Buffer.from(chunk.slice(0, 200))
//               .toString("utf-8")
//               .slice(0, 200)} (...)`
//           );
//         }
...
//         // React component errors should be handled naturally by React's HTML streaming
//         if (panicError != null) {
//           sendMessage({
//             type: "ERROR",
//             id,
...
//           } satisfies HtmlWorkerOutputMessage);
//         }
//         // If not a panic error, let React handle it naturally in the stream
