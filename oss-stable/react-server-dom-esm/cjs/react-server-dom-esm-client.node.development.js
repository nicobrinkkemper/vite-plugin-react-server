  ...
  (function () {
    ...
    function startReadingFromStream(response$jscomp$0, stream, onEnd) {
      ...
      stream.on("data", function (chunk) {
        ...
        } else if (!hasGCedResponse(response$jscomp$0)) {
          response = unwrapWeakResponse(response$jscomp$0);
          rowLength = 0;
            ...
            if (-1 < lastIdx)
              (rowState = new Uint8Array(
                ...
                98 === i
                  ? resolveBuffer(
                      response,
                      rowID,
                      lastIdx === rowTag ? rowState : rowState.slice(),
                      streamState
                    )
              ...
              98 === i
                ? ((rowState -= chunk.byteLength),
                  resolveBuffer(response, rowID, chunk, streamState))
                : (buffer.push(chunk), (rowState -= chunk.byteLength));
              break;
            }
          }
