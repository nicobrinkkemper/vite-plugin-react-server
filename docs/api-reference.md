...
| `runner` | `"main" \| "isolated" \| "edge"` | **Required.** The execution paradigm: where react-server executes (see [Configuration → Runner](./configuration.md#runner)); validated against the process condition at config-resolve time | - |
